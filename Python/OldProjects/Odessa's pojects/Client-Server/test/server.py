...
obj = {
    'arrDB_name': arrDB_name,
    'arrDB_description': arrDB_description,
    'arrDB_image': arrDB_image,
    'arrDB_maproute': arrDB_maproute,
    'arrDB_like': arrDB_like,
    'arrDB_dislike': arrDB_dislike,
    'arrDES_name': arrDES_name,
    'arrDES_description': arrDES_description,
    'arrDES_image': arrDES_image
}
